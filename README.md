 ...
 **External references:**  
- [Competition details](https://cryptopond.xyz/modelfactory/detail/2564617)  
- [Model write-up](https://medium.com/@jrk101/bradley-terry-model-for-weighting-ethereum-repositories-27ac64a2c24c)

---

## Challenge Summary

Create a machine learning or metrics-based model that produces weights indicating the relative contribution of 45 core open-source Ethereum repositories to the Ethereum universe.
